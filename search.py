...
# pickle.dump(pca,open('pca_50.pickle','wb'))
pca = pickle.load(open('/home/rajesh/divya/image_search/MTP/caltech_256_features/pca_50.pickle', 'rb'))
# print(pca)
...
# we have all the hashcodes whose parts have a hamming distance of 3 w.r.t the query image hashcode parts
# we proceed for fine search i.e. computing hamming distanc of the entire hashcode 
# top 5 minimum distance image address are stored as results
...
def printing_results(address_list):
    ...
    # print(results)
    for f in results:
        os.remove(os.path.join('/home/rajesh/divya/image_search/REST_API/static/results/', f))
    # results = os.listdir('static/results/')
...
def call_search(file_path):
    ...
    # print('features new',ed1-st1)
    # print('stage_one_search',ed2-st2)
    # print('fine search',ed3-st3)
